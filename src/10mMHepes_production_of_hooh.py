...
Hepes_10_df = pd.read_excel('../data/data_fig1a_Morris_and_Zinser_2013.xlsx', header = 2)   #importing data while ignoring 2 header rows
Hepes_10_df.columns = ['Time (days)', 'HOOH Concentration (\u03BCM)']     #renaming columns of dataframe so they are labeled appropriately 



#print(Hepes_10_df)                             #printing df to make sure I have all the data and labels correct
#print(Hepes_10_df[['Time (days)']])                  #making sure I can call the columns by thier new names
#print(Hepes_10_df[['HOOH Concentration (\u03BCM)']])
